...
module.exports = function (proto) {
  ...
  // http://www.imagemagick.org/script/command-line-options.php?#interline-spacing
  // the space between two text lines.
  proto.interlineSpace = function interlineSpace (lineHeight) {
    return this.out("-interline-spacing", lineHeight);
  }
